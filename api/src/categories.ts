...
const CATEGORY_TREE: { id: string; children: { id: string }[] }[] = [
  ...
  { id: "Торты", children: [{ id: "Торты на заказ" }, { id: "Детские торты" }, { id: "Капкейки" }, { id: "Пирожные и десерты" }, { id: "Праздничная выпечка" }] },
  { id: "Психолог", children: [{ id: "Детский психолог" }, { id: "Семейный психолог" }, { id: "Подростковый психолог" }, { id: "Консультации для родителей" }] },
  { id: "Логопед", children: [{ id: "Постановка звуков" }, { id: "Развитие речи" }, { id: "Подготовка к школе (речь)" }, { id: "Логопедический массаж" }] },
  { id: "Другое", children: [] },
];
