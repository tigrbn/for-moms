    ...
    <div style={{ display: "grid", gap: 12 }}>
      <div className="card profile-card">
          ...
          <div className="profile-card-title-block">
            ...
            <div className="profile-card-meta-block">
              ...
              {p.type === "specialist" && p.specialist?.pricePerHour != null && (
                <div className="profile-card-price-row">
                  <span className="muted">цена за час:</span> <strong>{p.specialist.pricePerHour} ₽</strong>
                </div>
              )}
            </div>
          </div>
        ...
        <div className="profile-card-actions row">
          {tgUrl ? (
            <a className="btn btn-telegram" href={tgUrl} target="_blank" rel="noreferrer">
              Написать в Telegram
            </a>
          ) : (
